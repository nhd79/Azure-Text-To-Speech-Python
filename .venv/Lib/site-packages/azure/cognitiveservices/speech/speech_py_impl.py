...
DocstringForPropertyId = """
   ...
   *Values:*
    ...
    .. py:attribute:: SpeechServiceConnection_EndpointId
      ...
      Instead set :py:obj:`.SpeechConfig.endpoint_id`.
   ...
   .. py:attribute:: SpeechServiceConnection_SynthEnableCompressedAudioTransmission
      ...
      .. note::
        This property id was added in version 1.16.0.

   .. py:attribute:: SpeechServiceConnection_VoicesListEndpoint

      The Cognitive Services Speech Service voices list api endpoint (url). Under normal circumstances,
      you don't need to specify this property, SDK will construct it based on the region/host/endpoint of :py:class:`.SpeechConfig`.
    ...
    .. py:attribute:: SpeechServiceConnection_SingleLanguageIdPriority

      Single shot Language Id mode with either Latency or Accuracy as the value

      .. note::
        This property id was added in version 1.18.0

    .. py:attribute:: SpeechServiceConnection_ContinuousLanguageIdPriority

      Continuous Language Id mode with either Latency or Accuracy as the value
    ...
    .. py:attribute:: SpeechServiceResponse_RequestSnr
    ...
    .. py:attribute:: SpeechServiceResponse_TranslationRequestStablePartialResult
    ...
    .. py:attribute:: SpeechServiceResponse_SynthesisFirstByteLatencyMs

      The speech synthesis first byte latency in milliseconds. Read-only,
      available on final speech synthesis results. This measures the latency
      between when the synthesis is started to be processed, and the moment
      the first byte audio is available.

      .. note::
        This property id was added in version 1.17.0.

    .. py:attribute:: SpeechServiceResponse_SynthesisFinishLatencyMs

      The speech synthesis all bytes latency in milliseconds. Read-only,
      available on final speech synthesis results. This measures the latency
      between when the synthesis is started to be processed, and the moment
      the whole audio is synthesized.
      Added in version 1.17.0.

      .. note::
        This property id was added in version 1.17.0.

    .. py:attribute:: SpeechServiceResponse_SynthesisUnderrunTimeMs

      The underrun time for speech synthesis in milliseconds. Read-only,
      available on results in SynthesisCompleted events. This measures the
      total underrun time from :py:obj:`.AudioConfig_PlaybackBufferLengthInMs`
      is filled to synthesis completed.
    ...
    .. py:attribute:: AudioConfig_PlaybackBufferLengthInMs
    ...
    .. py:attribute:: PronunciationAssessment_EnableMiscue
      ...
      and will be marked with omission/insertion based on the comparison.
      When disabled, the recognized text will always be reference text. The default setting is False.
      Under normal circumstances, you shouldn't have to use this property directly.
...
DocstringForResultReason = """
   ...
   *Values:*
   ...
   .. py:attribute:: VoicesListRetrieved
...
DocstringForSpeechSynthesisOutputFormat = """
   ...
   *Values:*
   ...
   .. py:attribute::Raw48Khz16BitMonoPcm

      raw-48khz-16bit-mono-pcm

   .. py:attribute::Riff48Khz16BitMonoPcm

      riff-48khz-16bit-mono-pcm

   .. py:attribute::Audio48Khz96KBitRateMonoMp3

      audio-48khz-96kbitrate-mono-mp3

   .. py:attribute::Audio48Khz192KBitRateMonoMp3

      audio-48khz-192kbitrate-mono-mp3

   .. py:attribute::Ogg48Khz16BitMonoOpus
   ...
   .. py:attribute::Webm16Khz16BitMonoOpus
   ...
   .. py:attribute::Webm24Khz16BitMonoOpus
   ...
   .. py:attribute::Raw24Khz16BitMonoTrueSilk
   ...
   .. py:attribute::Raw8Khz8BitMonoALaw
   ...
   .. py:attribute::Riff8Khz8BitMonoALaw
   ...
   .. py:attribute::Webm24Khz16Bit24KbpsMonoOpus
...
DocstringForSynthesisVoiceType = """
   ...
   *Values:*
   ...
   .. py:attribute:: OnlineNeural

      Online neural voice.

   .. py:attribute:: OnlineStandard

      Online standard voice.

   .. py:attribute:: OfflineNeural

      Offline neural voice.

   .. py:attribute:: OfflineStandard

      Offline standard voice.
    """

DocstringForSynthesisVoiceGender = """
...
def split(str , delim )  :
    return _speech_py_impl.split(str, delim)
split = _speech_py_impl.split
...
PropertyId_SpeechServiceConnection_RecoBackend = _speech_py_impl.PropertyId_SpeechServiceConnection_RecoBackend
PropertyId_SpeechServiceConnection_RecoModelName = _speech_py_impl.PropertyId_SpeechServiceConnection_RecoModelName
PropertyId_SpeechServiceConnection_RecoModelKey = _speech_py_impl.PropertyId_SpeechServiceConnection_RecoModelKey
PropertyId_SpeechServiceConnection_RecoModelIniFile = _speech_py_impl.PropertyId_SpeechServiceConnection_RecoModelIniFile
...
PropertyId_SpeechServiceConnection_SynthEnableCompressedAudioTransmission = _speech_py_impl.PropertyId_SpeechServiceConnection_SynthEnableCompressedAudioTransmission
PropertyId_SpeechServiceConnection_SynthBackend = _speech_py_impl.PropertyId_SpeechServiceConnection_SynthBackend
PropertyId_SpeechServiceConnection_SynthOfflineDataPath = _speech_py_impl.PropertyId_SpeechServiceConnection_SynthOfflineDataPath
PropertyId_SpeechServiceConnection_SynthOfflineVoice = _speech_py_impl.PropertyId_SpeechServiceConnection_SynthOfflineVoice
PropertyId_SpeechServiceConnection_SynthModelKey = _speech_py_impl.PropertyId_SpeechServiceConnection_SynthModelKey
PropertyId_SpeechServiceConnection_VoicesListEndpoint = _speech_py_impl.PropertyId_SpeechServiceConnection_VoicesListEndpoint
...
PropertyId_SpeechServiceConnection_SingleLanguageIdPriority = _speech_py_impl.PropertyId_SpeechServiceConnection_SingleLanguageIdPriority
PropertyId_SpeechServiceConnection_ContinuousLanguageIdPriority = _speech_py_impl.PropertyId_SpeechServiceConnection_ContinuousLanguageIdPriority
...
PropertyId_SpeechServiceResponse_RequestSnr = _speech_py_impl.PropertyId_SpeechServiceResponse_RequestSnr
...
PropertyId_SpeechServiceResponse_SynthesisFirstByteLatencyMs = _speech_py_impl.PropertyId_SpeechServiceResponse_SynthesisFirstByteLatencyMs
PropertyId_SpeechServiceResponse_SynthesisFinishLatencyMs = _speech_py_impl.PropertyId_SpeechServiceResponse_SynthesisFinishLatencyMs
PropertyId_SpeechServiceResponse_SynthesisUnderrunTimeMs = _speech_py_impl.PropertyId_SpeechServiceResponse_SynthesisUnderrunTimeMs
PropertyId_SpeechServiceResponse_SynthesisBackend = _speech_py_impl.PropertyId_SpeechServiceResponse_SynthesisBackend
...
PropertyId_AudioConfig_DeviceNameForRender = _speech_py_impl.PropertyId_AudioConfig_DeviceNameForRender
PropertyId_AudioConfig_PlaybackBufferLengthInMs = _speech_py_impl.PropertyId_AudioConfig_PlaybackBufferLengthInMs
PropertyId_AudioConfig_AudioProcessingOptions = _speech_py_impl.PropertyId_AudioConfig_AudioProcessingOptions
...
PropertyId_Conversation_Speech_Activity_Template = _speech_py_impl.PropertyId_Conversation_Speech_Activity_Template
PropertyId_Conversation_ParticipantId = _speech_py_impl.PropertyId_Conversation_ParticipantId
PropertyId_Conversation_Request_Bot_Status_Messages = _speech_py_impl.PropertyId_Conversation_Request_Bot_Status_Messages
PropertyId_Conversation_Connection_Id = _speech_py_impl.PropertyId_Conversation_Connection_Id
...
PropertyId_PronunciationAssessment_ReferenceText = _speech_py_impl.PropertyId_PronunciationAssessment_ReferenceText
PropertyId_PronunciationAssessment_GradingSystem = _speech_py_impl.PropertyId_PronunciationAssessment_GradingSystem
PropertyId_PronunciationAssessment_Granularity = _speech_py_impl.PropertyId_PronunciationAssessment_Granularity
PropertyId_PronunciationAssessment_EnableMiscue = _speech_py_impl.PropertyId_PronunciationAssessment_EnableMiscue
PropertyId_PronunciationAssessment_Json = _speech_py_impl.PropertyId_PronunciationAssessment_Json
PropertyId_PronunciationAssessment_Params = _speech_py_impl.PropertyId_PronunciationAssessment_Params
PropertyId_SpeakerRecognition_Api_Version = _speech_py_impl.PropertyId_SpeakerRecognition_Api_Version
...
ResultReason_EnrollingVoiceProfile = _speech_py_impl.ResultReason_EnrollingVoiceProfile
ResultReason_EnrolledVoiceProfile = _speech_py_impl.ResultReason_EnrolledVoiceProfile
ResultReason_RecognizedSpeakers = _speech_py_impl.ResultReason_RecognizedSpeakers
ResultReason_RecognizedSpeaker = _speech_py_impl.ResultReason_RecognizedSpeaker
ResultReason_ResetVoiceProfile = _speech_py_impl.ResultReason_ResetVoiceProfile
ResultReason_DeletedVoiceProfile = _speech_py_impl.ResultReason_DeletedVoiceProfile
ResultReason_VoicesListRetrieved = _speech_py_impl.ResultReason_VoicesListRetrieved
...
CancellationReason_CancelledByUser = _speech_py_impl.CancellationReason_CancelledByUser
...
CancellationErrorCode_ServiceRedirectTemporary = _speech_py_impl.CancellationErrorCode_ServiceRedirectTemporary
CancellationErrorCode_ServiceRedirectPermanent = _speech_py_impl.CancellationErrorCode_ServiceRedirectPermanent
CancellationErrorCode_EmbeddedModelError = _speech_py_impl.CancellationErrorCode_EmbeddedModelError
...
SpeechSynthesisOutputFormat_Ogg16Khz16BitMonoOpus = _speech_py_impl.SpeechSynthesisOutputFormat_Ogg16Khz16BitMonoOpus
SpeechSynthesisOutputFormat_Ogg24Khz16BitMonoOpus = _speech_py_impl.SpeechSynthesisOutputFormat_Ogg24Khz16BitMonoOpus
SpeechSynthesisOutputFormat_Raw48Khz16BitMonoPcm = _speech_py_impl.SpeechSynthesisOutputFormat_Raw48Khz16BitMonoPcm
SpeechSynthesisOutputFormat_Riff48Khz16BitMonoPcm = _speech_py_impl.SpeechSynthesisOutputFormat_Riff48Khz16BitMonoPcm
SpeechSynthesisOutputFormat_Audio48Khz96KBitRateMonoMp3 = _speech_py_impl.SpeechSynthesisOutputFormat_Audio48Khz96KBitRateMonoMp3
SpeechSynthesisOutputFormat_Audio48Khz192KBitRateMonoMp3 = _speech_py_impl.SpeechSynthesisOutputFormat_Audio48Khz192KBitRateMonoMp3
SpeechSynthesisOutputFormat_Ogg48Khz16BitMonoOpus = _speech_py_impl.SpeechSynthesisOutputFormat_Ogg48Khz16BitMonoOpus
SpeechSynthesisOutputFormat_Webm16Khz16BitMonoOpus = _speech_py_impl.SpeechSynthesisOutputFormat_Webm16Khz16BitMonoOpus
SpeechSynthesisOutputFormat_Webm24Khz16BitMonoOpus = _speech_py_impl.SpeechSynthesisOutputFormat_Webm24Khz16BitMonoOpus
SpeechSynthesisOutputFormat_Raw24Khz16BitMonoTrueSilk = _speech_py_impl.SpeechSynthesisOutputFormat_Raw24Khz16BitMonoTrueSilk
SpeechSynthesisOutputFormat_Raw8Khz8BitMonoALaw = _speech_py_impl.SpeechSynthesisOutputFormat_Raw8Khz8BitMonoALaw
SpeechSynthesisOutputFormat_Riff8Khz8BitMonoALaw = _speech_py_impl.SpeechSynthesisOutputFormat_Riff8Khz8BitMonoALaw
SpeechSynthesisOutputFormat_Webm24Khz16Bit24KbpsMonoOpus = _speech_py_impl.SpeechSynthesisOutputFormat_Webm24Khz16Bit24KbpsMonoOpus
...
ServicePropertyChannel_HttpHeader = _speech_py_impl.ServicePropertyChannel_HttpHeader
...
EntityType_Any = _speech_py_impl.EntityType_Any
EntityType_List = _speech_py_impl.EntityType_List
EntityType_PrebuiltInteger = _speech_py_impl.EntityType_PrebuiltInteger
EntityMatchMode_Basic = _speech_py_impl.EntityMatchMode_Basic
EntityMatchMode_Strict = _speech_py_impl.EntityMatchMode_Strict
EntityMatchMode_Fuzzy = _speech_py_impl.EntityMatchMode_Fuzzy
EntityGreed_Lazy = _speech_py_impl.EntityGreed_Lazy
EntityGreed_Greedy = _speech_py_impl.EntityGreed_Greedy
VoiceProfileType_TextIndependentIdentification = _speech_py_impl.VoiceProfileType_TextIndependentIdentification
VoiceProfileType_TextDependentVerification = _speech_py_impl.VoiceProfileType_TextDependentVerification
VoiceProfileType_TextIndependentVerification = _speech_py_impl.VoiceProfileType_TextIndependentVerification
RecognitionFactorScope_PartialPhrase = _speech_py_impl.RecognitionFactorScope_PartialPhrase
PronunciationAssessmentGradingSystem_FivePoint = _speech_py_impl.PronunciationAssessmentGradingSystem_FivePoint
PronunciationAssessmentGradingSystem_HundredMark = _speech_py_impl.PronunciationAssessmentGradingSystem_HundredMark
PronunciationAssessmentGranularity_Phoneme = _speech_py_impl.PronunciationAssessmentGranularity_Phoneme
PronunciationAssessmentGranularity_Word = _speech_py_impl.PronunciationAssessmentGranularity_Word
PronunciationAssessmentGranularity_FullText = _speech_py_impl.PronunciationAssessmentGranularity_FullText
SynthesisVoiceType_OnlineNeural = _speech_py_impl.SynthesisVoiceType_OnlineNeural
SynthesisVoiceType_OnlineStandard = _speech_py_impl.SynthesisVoiceType_OnlineStandard
SynthesisVoiceType_OfflineNeural = _speech_py_impl.SynthesisVoiceType_OfflineNeural
SynthesisVoiceType_OfflineStandard = _speech_py_impl.SynthesisVoiceType_OfflineStandard
SynthesisVoiceGender_Unknown = _speech_py_impl.SynthesisVoiceGender_Unknown
SynthesisVoiceGender_Female = _speech_py_impl.SynthesisVoiceGender_Female
SynthesisVoiceGender_Male = _speech_py_impl.SynthesisVoiceGender_Male
...
class KeywordRecognitionResultPtrFuture(_object):
    __swig_setmethods__ = {}
    __setattr__ = lambda self, name, value: _swig_setattr(self, KeywordRecognitionResultPtrFuture, name, value)
    __swig_getmethods__ = {}
    __getattr__ = lambda self, name: _swig_getattr(self, KeywordRecognitionResultPtrFuture, name)

    def __init__(self, *args, **kwargs):
        raise AttributeError("No constructor defined")
    __repr__ = _swig_repr
    __swig_destroy__ = _speech_py_impl.delete_KeywordRecognitionResultPtrFuture
    __del__ = lambda self: None

    def get(self)  :
        return _speech_py_impl.KeywordRecognitionResultPtrFuture_get(self)
KeywordRecognitionResultPtrFuture_swigregister = _speech_py_impl.KeywordRecognitionResultPtrFuture_swigregister
KeywordRecognitionResultPtrFuture_swigregister(KeywordRecognitionResultPtrFuture)
...
class SynthesisVoicesResultPtrFuture(_object):
    __swig_setmethods__ = {}
    __setattr__ = lambda self, name, value: _swig_setattr(self, SynthesisVoicesResultPtrFuture, name, value)
    __swig_getmethods__ = {}
    __getattr__ = lambda self, name: _swig_getattr(self, SynthesisVoicesResultPtrFuture, name)

    def __init__(self, *args, **kwargs):
        raise AttributeError("No constructor defined")
    __repr__ = _swig_repr
    __swig_destroy__ = _speech_py_impl.delete_SynthesisVoicesResultPtrFuture
    __del__ = lambda self: None

    def get(self)  :
        return _speech_py_impl.SynthesisVoicesResultPtrFuture_get(self)
SynthesisVoicesResultPtrFuture_swigregister = _speech_py_impl.SynthesisVoicesResultPtrFuture_swigregister
SynthesisVoicesResultPtrFuture_swigregister(SynthesisVoicesResultPtrFuture)
...
class VoiceInfoVector(_object):
    __swig_setmethods__ = {}
    __setattr__ = lambda self, name, value: _swig_setattr(self, VoiceInfoVector, name, value)
    __swig_getmethods__ = {}
    __getattr__ = lambda self, name: _swig_getattr(self, VoiceInfoVector, name)
    __repr__ = _swig_repr

    def iterator(self)  :
        return _speech_py_impl.VoiceInfoVector_iterator(self)
    def __iter__(self):
        return self.iterator()

    def __nonzero__(self)  :
        return _speech_py_impl.VoiceInfoVector___nonzero__(self)

    def __bool__(self)  :
        return _speech_py_impl.VoiceInfoVector___bool__(self)

    def __len__(self)  :
        return _speech_py_impl.VoiceInfoVector___len__(self)

    def __getslice__(self, i , j )  :
        return _speech_py_impl.VoiceInfoVector___getslice__(self, i, j)

    def __setslice__(self, *args)  :
        return _speech_py_impl.VoiceInfoVector___setslice__(self, *args)

    def __delslice__(self, i , j )  :
        return _speech_py_impl.VoiceInfoVector___delslice__(self, i, j)

    def __delitem__(self, *args)  :
        return _speech_py_impl.VoiceInfoVector___delitem__(self, *args)

    def __getitem__(self, *args)  :
        return _speech_py_impl.VoiceInfoVector___getitem__(self, *args)

    def __setitem__(self, *args)  :
        return _speech_py_impl.VoiceInfoVector___setitem__(self, *args)

    def pop(self)  :
        return _speech_py_impl.VoiceInfoVector_pop(self)

    def append(self, x )  :
        return _speech_py_impl.VoiceInfoVector_append(self, x)

    def empty(self)  :
        return _speech_py_impl.VoiceInfoVector_empty(self)

    def size(self)  :
        return _speech_py_impl.VoiceInfoVector_size(self)

    def swap(self, v )  :
        return _speech_py_impl.VoiceInfoVector_swap(self, v)

    def begin(self)  :
        return _speech_py_impl.VoiceInfoVector_begin(self)

    def end(self)  :
        return _speech_py_impl.VoiceInfoVector_end(self)

    def rbegin(self)  :
        return _speech_py_impl.VoiceInfoVector_rbegin(self)

    def rend(self)  :
        return _speech_py_impl.VoiceInfoVector_rend(self)

    def clear(self)  :
        return _speech_py_impl.VoiceInfoVector_clear(self)

    def get_allocator(self)  :
        return _speech_py_impl.VoiceInfoVector_get_allocator(self)

    def pop_back(self)  :
        return _speech_py_impl.VoiceInfoVector_pop_back(self)

    def erase(self, *args)  :
        return _speech_py_impl.VoiceInfoVector_erase(self, *args)

    def __init__(self, *args):
        this = _speech_py_impl.new_VoiceInfoVector(*args)
        try:
            self.this.append(this)
        except __builtin__.Exception:
            self.this = this
    ...
    def push_back(self, x )  :
        return _speech_py_impl.VoiceInfoVector_push_back(self, x)

    def front(self)  :
        return _speech_py_impl.VoiceInfoVector_front(self)

    def back(self)  :
        return _speech_py_impl.VoiceInfoVector_back(self)

    def assign(self, n , x )  :
        return _speech_py_impl.VoiceInfoVector_assign(self, n, x)

    def resize(self, *args)  :
        return _speech_py_impl.VoiceInfoVector_resize(self, *args)

    def insert(self, *args)  :
        return _speech_py_impl.VoiceInfoVector_insert(self, *args)

    def reserve(self, n )  :
        return _speech_py_impl.VoiceInfoVector_reserve(self, n)

    def capacity(self)  :
        return _speech_py_impl.VoiceInfoVector_capacity(self)
    __swig_destroy__ = _speech_py_impl.delete_VoiceInfoVector
    __del__ = lambda self: None
VoiceInfoVector_swigregister = _speech_py_impl.VoiceInfoVector_swigregister
VoiceInfoVector_swigregister(VoiceInfoVector)
...
def BotFrameworkConfig_from_subscription(*args)  :
    return _speech_py_impl.BotFrameworkConfig_from_subscription(*args)
BotFrameworkConfig_from_subscription = _speech_py_impl.BotFrameworkConfig_from_subscription

def BotFrameworkConfig_from_authorization_token(*args)  :
    return _speech_py_impl.BotFrameworkConfig_from_authorization_token(*args)
...
class SourceLanguageConfig(_object):
    ...
    __repr__ = _swig_repr
    if _newclass:
        _from_language = staticmethod(_speech_py_impl.SourceLanguageConfig__from_language)
    else:
        _from_language = _speech_py_impl.SourceLanguageConfig__from_language
...
def SourceLanguageConfig__from_language(*args)  :
    return _speech_py_impl.SourceLanguageConfig__from_language(*args)
SourceLanguageConfig__from_language = _speech_py_impl.SourceLanguageConfig__from_language
...
class AutoDetectSourceLanguageConfig(_object):
    ...
    __repr__ = _swig_repr
    if _newclass:
        _from_open_range = staticmethod(_speech_py_impl.AutoDetectSourceLanguageConfig__from_open_range)
    else:
        _from_open_range = _speech_py_impl.AutoDetectSourceLanguageConfig__from_open_range
    if _newclass:
        _from_languages = staticmethod(_speech_py_impl.AutoDetectSourceLanguageConfig__from_languages)
    else:
        _from_languages = _speech_py_impl.AutoDetectSourceLanguageConfig__from_languages
    if _newclass:
        _from_source_language_configs = staticmethod(_speech_py_impl.AutoDetectSourceLanguageConfig__from_source_language_configs)
    else:
        _from_source_language_configs = _speech_py_impl.AutoDetectSourceLanguageConfig__from_source_language_configs
...
def AutoDetectSourceLanguageConfig__from_open_range()  :
    return _speech_py_impl.AutoDetectSourceLanguageConfig__from_open_range()
AutoDetectSourceLanguageConfig__from_open_range = _speech_py_impl.AutoDetectSourceLanguageConfig__from_open_range

def AutoDetectSourceLanguageConfig__from_languages(languages )  :
    return _speech_py_impl.AutoDetectSourceLanguageConfig__from_languages(languages)
AutoDetectSourceLanguageConfig__from_languages = _speech_py_impl.AutoDetectSourceLanguageConfig__from_languages

def AutoDetectSourceLanguageConfig__from_source_language_configs(configList )  :
    return _speech_py_impl.AutoDetectSourceLanguageConfig__from_source_language_configs(configList)
AutoDetectSourceLanguageConfig__from_source_language_configs = _speech_py_impl.AutoDetectSourceLanguageConfig__from_source_language_configs
...
PresetMicrophoneArrayGeometry_Uninitialized = _speech_py_impl.PresetMicrophoneArrayGeometry_Uninitialized
PresetMicrophoneArrayGeometry_Circular7 = _speech_py_impl.PresetMicrophoneArrayGeometry_Circular7
PresetMicrophoneArrayGeometry_Circular4 = _speech_py_impl.PresetMicrophoneArrayGeometry_Circular4
PresetMicrophoneArrayGeometry_Linear4 = _speech_py_impl.PresetMicrophoneArrayGeometry_Linear4
PresetMicrophoneArrayGeometry_Linear2 = _speech_py_impl.PresetMicrophoneArrayGeometry_Linear2
PresetMicrophoneArrayGeometry_Mono = _speech_py_impl.PresetMicrophoneArrayGeometry_Mono
PresetMicrophoneArrayGeometry_Custom = _speech_py_impl.PresetMicrophoneArrayGeometry_Custom
MicrophoneArrayType_Linear = _speech_py_impl.MicrophoneArrayType_Linear
MicrophoneArrayType_Planar = _speech_py_impl.MicrophoneArrayType_Planar
SpeakerReferenceChannel__None = _speech_py_impl.SpeakerReferenceChannel__None
SpeakerReferenceChannel_LastChannel = _speech_py_impl.SpeakerReferenceChannel_LastChannel
class MicrophoneArrayGeometry(_object):
    __swig_setmethods__ = {}
    __setattr__ = lambda self, name, value: _swig_setattr(self, MicrophoneArrayGeometry, name, value)
    __swig_getmethods__ = {}
    __getattr__ = lambda self, name: _swig_getattr(self, MicrophoneArrayGeometry, name)
    __repr__ = _swig_repr
    __swig_setmethods__["microphone_array_type"] = _speech_py_impl.MicrophoneArrayGeometry_microphone_array_type_set
    __swig_getmethods__["microphone_array_type"] = _speech_py_impl.MicrophoneArrayGeometry_microphone_array_type_get
    if _newclass:
        microphone_array_type = _swig_property(_speech_py_impl.MicrophoneArrayGeometry_microphone_array_type_get, _speech_py_impl.MicrophoneArrayGeometry_microphone_array_type_set)
    __swig_setmethods__["beamforming_start_angle"] = _speech_py_impl.MicrophoneArrayGeometry_beamforming_start_angle_set
    __swig_getmethods__["beamforming_start_angle"] = _speech_py_impl.MicrophoneArrayGeometry_beamforming_start_angle_get
    if _newclass:
        beamforming_start_angle = _swig_property(_speech_py_impl.MicrophoneArrayGeometry_beamforming_start_angle_get, _speech_py_impl.MicrophoneArrayGeometry_beamforming_start_angle_set)
    __swig_setmethods__["beamforming_end_angle"] = _speech_py_impl.MicrophoneArrayGeometry_beamforming_end_angle_set
    __swig_getmethods__["beamforming_end_angle"] = _speech_py_impl.MicrophoneArrayGeometry_beamforming_end_angle_get
    if _newclass:
        beamforming_end_angle = _swig_property(_speech_py_impl.MicrophoneArrayGeometry_beamforming_end_angle_get, _speech_py_impl.MicrophoneArrayGeometry_beamforming_end_angle_set)
    __swig_setmethods__["microphone_coordinates"] = _speech_py_impl.MicrophoneArrayGeometry_microphone_coordinates_set
    __swig_getmethods__["microphone_coordinates"] = _speech_py_impl.MicrophoneArrayGeometry_microphone_coordinates_get
    if _newclass:
        microphone_coordinates = _swig_property(_speech_py_impl.MicrophoneArrayGeometry_microphone_coordinates_get, _speech_py_impl.MicrophoneArrayGeometry_microphone_coordinates_set)

    def __init__(self, *args):
        this = _speech_py_impl.new_MicrophoneArrayGeometry(*args)
        try:
            self.this.append(this)
        except __builtin__.Exception:
            self.this = this
    __swig_destroy__ = _speech_py_impl.delete_MicrophoneArrayGeometry
    __del__ = lambda self: None
MicrophoneArrayGeometry_swigregister = _speech_py_impl.MicrophoneArrayGeometry_swigregister
MicrophoneArrayGeometry_swigregister(MicrophoneArrayGeometry)

class AudioProcessingOptions(_object):
    __swig_setmethods__ = {}
    __setattr__ = lambda self, name, value: _swig_setattr(self, AudioProcessingOptions, name, value)
    __swig_getmethods__ = {}
    __getattr__ = lambda self, name: _swig_getattr(self, AudioProcessingOptions, name)
    __repr__ = _swig_repr

    def __init__(self, hoptions ):
        this = _speech_py_impl.new_AudioProcessingOptions(hoptions)
        try:
            self.this.append(this)
        except __builtin__.Exception:
            self.this = this
    __swig_destroy__ = _speech_py_impl.delete_AudioProcessingOptions
    __del__ = lambda self: None
    if _newclass:
        create = staticmethod(_speech_py_impl.AudioProcessingOptions_create)
    else:
        create = _speech_py_impl.AudioProcessingOptions_create

    def get_audio_processing_flags(self)  :
        return _speech_py_impl.AudioProcessingOptions_get_audio_processing_flags(self)

    def get_preset_microphone_array_geometry(self)  :
        return _speech_py_impl.AudioProcessingOptions_get_preset_microphone_array_geometry(self)

    def get_microphone_array_type(self)  :
        return _speech_py_impl.AudioProcessingOptions_get_microphone_array_type(self)

    def get_beamforming_start_angle(self)  :
        return _speech_py_impl.AudioProcessingOptions_get_beamforming_start_angle(self)

    def get_beamforming_end_angle(self)  :
        return _speech_py_impl.AudioProcessingOptions_get_beamforming_end_angle(self)

    def get_microphone_coordinates(self)  :
        return _speech_py_impl.AudioProcessingOptions_get_microphone_coordinates(self)

    def get_speaker_reference_channel(self)  :
        return _speech_py_impl.AudioProcessingOptions_get_speaker_reference_channel(self)
AudioProcessingOptions_swigregister = _speech_py_impl.AudioProcessingOptions_swigregister
AudioProcessingOptions_swigregister(AudioProcessingOptions)

def AudioProcessingOptions_create(*args)  :
    return _speech_py_impl.AudioProcessingOptions_create(*args)
AudioProcessingOptions_create = _speech_py_impl.AudioProcessingOptions_create
...
AudioStreamContainerFormat_ANY = _speech_py_impl.AudioStreamContainerFormat_ANY
...
class AudioConfig(_object):
    ...
    if _newclass:
        _from_speaker_output = staticmethod(_speech_py_impl.AudioConfig__from_speaker_output)
    else:
        _from_speaker_output = _speech_py_impl.AudioConfig__from_speaker_output
    if _newclass:
    ...
    def get_audio_processing_options(self)  :
        return _speech_py_impl.AudioConfig_get_audio_processing_options(self)
...
def AudioConfig__from_default_microphone_input(*args)  :
    return _speech_py_impl.AudioConfig__from_default_microphone_input(*args)
AudioConfig__from_default_microphone_input = _speech_py_impl.AudioConfig__from_default_microphone_input

def AudioConfig__from_microphone_input(*args)  :
    return _speech_py_impl.AudioConfig__from_microphone_input(*args)
AudioConfig__from_microphone_input = _speech_py_impl.AudioConfig__from_microphone_input

def AudioConfig__from_wav_file_input(*args)  :
    return _speech_py_impl.AudioConfig__from_wav_file_input(*args)
AudioConfig__from_wav_file_input = _speech_py_impl.AudioConfig__from_wav_file_input

def AudioConfig__from_stream_input(*args)  :
    return _speech_py_impl.AudioConfig__from_stream_input(*args)
...
def AudioConfig__from_speaker_output(deviceName )  :
    return _speech_py_impl.AudioConfig__from_speaker_output(deviceName)
AudioConfig__from_speaker_output = _speech_py_impl.AudioConfig__from_speaker_output
...
class ConnectionEventArgs(SessionEventArgs):
    ...
    __del__ = lambda self: None
    __swig_getmethods__["properties"] = _speech_py_impl.ConnectionEventArgs_properties_get
    if _newclass:
        properties = _swig_property(_speech_py_impl.ConnectionEventArgs_properties_get)
...
class SessionEventSignal(_object):
    ...
    def signal(self, t )  :
        ...
        """
        return _speech_py_impl.SessionEventSignal_signal(self, t)
...
class RecognitionEventSignal(_object):
    ...
    def signal(self, t )  :
        ...
        """
        return _speech_py_impl.RecognitionEventSignal_signal(self, t)
...
class ConnectionEventSignal(_object):
    ...
    def signal(self, t )  :
        ...
        """
        return _speech_py_impl.ConnectionEventSignal_signal(self, t)
...
class AutoDetectSourceLanguageResult(_object):
    ...
    __repr__ = _swig_repr
    if _newclass:
        _from_result = staticmethod(_speech_py_impl.AutoDetectSourceLanguageResult__from_result)
    else:
        _from_result = _speech_py_impl.AutoDetectSourceLanguageResult__from_result
...
def AutoDetectSourceLanguageResult__from_result(result )  :
    return _speech_py_impl.AutoDetectSourceLanguageResult__from_result(result)
AutoDetectSourceLanguageResult__from_result = _speech_py_impl.AutoDetectSourceLanguageResult__from_result
...
class SpeechRecognitionEventSignal(_object):
    ...
    def signal(self, t )  :
        ...
        """
        return _speech_py_impl.SpeechRecognitionEventSignal_signal(self, t)
...
class SpeechRecognitionCanceledEventSignal(_object):
    ...
    def signal(self, t )  :
        ...
        """
        return _speech_py_impl.SpeechRecognitionCanceledEventSignal_signal(self, t)
...
class SourceLanguageRecognizer(SpeechRecognizerBase):
    __swig_setmethods__ = {}
    for _s in [SpeechRecognizerBase]:
        __swig_setmethods__.update(getattr(_s, '__swig_setmethods__', {}))
    __setattr__ = lambda self, name, value: _swig_setattr(self, SourceLanguageRecognizer, name, value)
    __swig_getmethods__ = {}
    for _s in [SpeechRecognizerBase]:
        __swig_getmethods__.update(getattr(_s, '__swig_getmethods__', {}))
    __getattr__ = lambda self, name: _swig_getattr(self, SourceLanguageRecognizer, name)
    __repr__ = _swig_repr
    if _newclass:
        _from_config = staticmethod(_speech_py_impl.SourceLanguageRecognizer__from_config)
    else:
        _from_config = _speech_py_impl.SourceLanguageRecognizer__from_config

    def __init__(self, hreco ):
        this = _speech_py_impl.new_SourceLanguageRecognizer(hreco)
        try:
            self.this.append(this)
        except __builtin__.Exception:
            self.this = this
    __swig_destroy__ = _speech_py_impl.delete_SourceLanguageRecognizer
    __del__ = lambda self: None
    __swig_getmethods__["properties"] = _speech_py_impl.SourceLanguageRecognizer_properties_get
    if _newclass:
        properties = _swig_property(_speech_py_impl.SourceLanguageRecognizer_properties_get)

    def get_endpoint_id(self)  :
        return _speech_py_impl.SourceLanguageRecognizer_get_endpoint_id(self)

    def set_authorization_token(self, token )  :
        return _speech_py_impl.SourceLanguageRecognizer_set_authorization_token(self, token)

    def get_authorization_token(self)  :
        return _speech_py_impl.SourceLanguageRecognizer_get_authorization_token(self)

    def recognize_once(self)  :
        return _speech_py_impl.SourceLanguageRecognizer_recognize_once(self)

    def start_continuous_recognition(self)  :
        return _speech_py_impl.SourceLanguageRecognizer_start_continuous_recognition(self)

    def stop_continuous_recognition(self)  :
        return _speech_py_impl.SourceLanguageRecognizer_stop_continuous_recognition(self)

    def start_keyword_recognition(self, model )  :
        return _speech_py_impl.SourceLanguageRecognizer_start_keyword_recognition(self, model)

    def stop_keyword_recognition(self)  :
        return _speech_py_impl.SourceLanguageRecognizer_stop_keyword_recognition(self)

    def recognize_once_async(self)  :
        return _speech_py_impl.SourceLanguageRecognizer_recognize_once_async(self)

    def start_continuous_recognition_async(self)  :
        return _speech_py_impl.SourceLanguageRecognizer_start_continuous_recognition_async(self)

    def stop_continuous_recognition_async(self)  :
        return _speech_py_impl.SourceLanguageRecognizer_stop_continuous_recognition_async(self)

    def start_keyword_recognition_async(self, model )  :
        return _speech_py_impl.SourceLanguageRecognizer_start_keyword_recognition_async(self, model)

    def stop_keyword_recognition_async(self)  :
        return _speech_py_impl.SourceLanguageRecognizer_stop_keyword_recognition_async(self)
SourceLanguageRecognizer_swigregister = _speech_py_impl.SourceLanguageRecognizer_swigregister
SourceLanguageRecognizer_swigregister(SourceLanguageRecognizer)

def SourceLanguageRecognizer__from_config(speechconfig , autoDetectSourceLangConfig , audioInput =0)  :
    return _speech_py_impl.SourceLanguageRecognizer__from_config(speechconfig, autoDetectSourceLangConfig, audioInput)
SourceLanguageRecognizer__from_config = _speech_py_impl.SourceLanguageRecognizer__from_config
...
class IntentRecognitionResult(RecognitionResult):
    ...
    def get_entities(self)  :
        return _speech_py_impl.IntentRecognitionResult_get_entities(self)
...
class LanguageUnderstandingModel(_object):
    ...
    __repr__ = _swig_repr
    language_understanding_model_type_pattern_matching_model = _speech_py_impl.LanguageUnderstandingModel_language_understanding_model_type_pattern_matching_model
    language_understanding_model_type_language_understanding_model = _speech_py_impl.LanguageUnderstandingModel_language_understanding_model_type_language_understanding_model
    if _newclass:
    ...
    def get_model_id(self)  :
        return _speech_py_impl.LanguageUnderstandingModel_get_model_id(self)

    def get_model_type(self)  :
        return _speech_py_impl.LanguageUnderstandingModel_get_model_type(self)
...
class IntentEventSignal(_object):
    ...
    def signal(self, t )  :
        ...
        """
        return _speech_py_impl.IntentEventSignal_signal(self, t)
...
class IntentCanceledEventSignal(_object):
    ...
    def signal(self, t )  :
        ...
        """
        return _speech_py_impl.IntentCanceledEventSignal_signal(self, t)
...
class ConversationTranscriptionResult(RecognitionResult):
    ...
    __swig_getmethods__["utterance_id"] = _speech_py_impl.ConversationTranscriptionResult_utterance_id_get
    if _newclass:
        utterance_id = _swig_property(_speech_py_impl.ConversationTranscriptionResult_utterance_id_get)
...
class ConversationTranscriberEventSignal(_object):
    ...
    def signal(self, t )  :
        ...
        """
        return _speech_py_impl.ConversationTranscriberEventSignal_signal(self, t)
...
class ConversationTranscriberCanceledEventSignal(_object):
    ...
    def signal(self, t )  :
        ...
        """
        return _speech_py_impl.ConversationTranscriberCanceledEventSignal_signal(self, t)
...
class IntentRecognizer(IntentRecognizerBase):
    ...
    def apply_language_models(self, collection )  :
        return _speech_py_impl.IntentRecognizer_apply_language_models(self, collection)
...
def IntentRecognizer__from_config(*args)  :
    return _speech_py_impl.IntentRecognizer__from_config(*args)
...
class TranslationTextEventSignal(_object):
    ...
    def signal(self, t )  :
        ...
        """
        return _speech_py_impl.TranslationTextEventSignal_signal(self, t)
...
class TranslationTextCanceledEventSignal(_object):
    ...
    def signal(self, t )  :
        ...
        """
        return _speech_py_impl.TranslationTextCanceledEventSignal_signal(self, t)
...
class TranslationSynthesisEventSignal(_object):
    ...
    def signal(self, t )  :
        ...
        """
        return _speech_py_impl.TranslationSynthesisEventSignal_signal(self, t)
...
class TurnStatusReceivedEventArgs(_object):
    __swig_setmethods__ = {}
    __setattr__ = lambda self, name, value: _swig_setattr(self, TurnStatusReceivedEventArgs, name, value)
    __swig_getmethods__ = {}
    __getattr__ = lambda self, name: _swig_getattr(self, TurnStatusReceivedEventArgs, name)

    def __init__(self, *args, **kwargs):
        raise AttributeError("No constructor defined")
    __repr__ = _swig_repr
    __swig_destroy__ = _speech_py_impl.delete_TurnStatusReceivedEventArgs
    __del__ = lambda self: None

    def get_interaction_id(self)  :
        return _speech_py_impl.TurnStatusReceivedEventArgs_get_interaction_id(self)

    def get_conversation_id(self)  :
        return _speech_py_impl.TurnStatusReceivedEventArgs_get_conversation_id(self)

    def get_status_code(self)  :
        return _speech_py_impl.TurnStatusReceivedEventArgs_get_status_code(self)
TurnStatusReceivedEventArgs_swigregister = _speech_py_impl.TurnStatusReceivedEventArgs_swigregister
TurnStatusReceivedEventArgs_swigregister(TurnStatusReceivedEventArgs)
...
class ActivityReceivedEventSignal(_object):
    ...
    def signal(self, t )  :
        ...
        """
        return _speech_py_impl.ActivityReceivedEventSignal_signal(self, t)
...
class TurnStatusReceivedEventListener(_object):
    __swig_setmethods__ = {}
    __setattr__ = lambda self, name, value: _swig_setattr(self, TurnStatusReceivedEventListener, name, value)
    __swig_getmethods__ = {}
    __getattr__ = lambda self, name: _swig_getattr(self, TurnStatusReceivedEventListener, name)
    ...
    def __call__(self, eventArgs )  :
        return _speech_py_impl.TurnStatusReceivedEventListener___call__(self, eventArgs)
    __swig_destroy__ = _speech_py_impl.delete_TurnStatusReceivedEventListener
    __del__ = lambda self: None
TurnStatusReceivedEventListener_swigregister = _speech_py_impl.TurnStatusReceivedEventListener_swigregister
TurnStatusReceivedEventListener_swigregister(TurnStatusReceivedEventListener)

class TurnStatusReceivedEventSignal(_object):
    """
    ...
    __swig_setmethods__ = {}
    __setattr__ = lambda self, name, value: _swig_setattr(self, TurnStatusReceivedEventSignal, name, value)
    __swig_getmethods__ = {}
    __getattr__ = lambda self, name: _swig_getattr(self, TurnStatusReceivedEventSignal, name)
    ...
    def disconnect_all(self)  :
        ...
        """
        return _speech_py_impl.TurnStatusReceivedEventSignal_disconnect_all(self)
    ...
    def signal(self, t )  :
        ...
        """
        return _speech_py_impl.TurnStatusReceivedEventSignal_signal(self, t)

    __swig_destroy__ = _speech_py_impl.delete_TurnStatusReceivedEventSignal
    __del__ = lambda self: None
TurnStatusReceivedEventSignal_swigregister = _speech_py_impl.TurnStatusReceivedEventSignal_swigregister
TurnStatusReceivedEventSignal_swigregister(TurnStatusReceivedEventSignal)
...
class AudioDataStream(_object):
    ...
    __del__ = lambda self: None
    if _newclass:
        from_wav_file_input = staticmethod(_speech_py_impl.AudioDataStream_from_wav_file_input)
    else:
        from_wav_file_input = _speech_py_impl.AudioDataStream_from_wav_file_input
    if _newclass:
    ...
    def detach_input(self)  :
        return _speech_py_impl.AudioDataStream_detach_input(self)
...
def AudioDataStream_from_wav_file_input(fileName )  :
    return _speech_py_impl.AudioDataStream_from_wav_file_input(fileName)
AudioDataStream_from_wav_file_input = _speech_py_impl.AudioDataStream_from_wav_file_input

def AudioDataStream__from_result(*args)  :
    return _speech_py_impl.AudioDataStream__from_result(*args)
...
class SpeechSynthesisVisemeEventArgs(EventArgs):
    __swig_setmethods__ = {}
    for _s in [EventArgs]:
        __swig_setmethods__.update(getattr(_s, '__swig_setmethods__', {}))
    __setattr__ = lambda self, name, value: _swig_setattr(self, SpeechSynthesisVisemeEventArgs, name, value)
    __swig_getmethods__ = {}
    for _s in [EventArgs]:
        __swig_getmethods__.update(getattr(_s, '__swig_getmethods__', {}))
    __getattr__ = lambda self, name: _swig_getattr(self, SpeechSynthesisVisemeEventArgs, name)

    def __init__(self, *args, **kwargs):
        raise AttributeError("No constructor defined")
    __repr__ = _swig_repr
    __swig_destroy__ = _speech_py_impl.delete_SpeechSynthesisVisemeEventArgs
    __del__ = lambda self: None
    __swig_setmethods__["audio_offset"] = _speech_py_impl.SpeechSynthesisVisemeEventArgs_audio_offset_set
    __swig_getmethods__["audio_offset"] = _speech_py_impl.SpeechSynthesisVisemeEventArgs_audio_offset_get
    if _newclass:
        audio_offset = _swig_property(_speech_py_impl.SpeechSynthesisVisemeEventArgs_audio_offset_get, _speech_py_impl.SpeechSynthesisVisemeEventArgs_audio_offset_set)
    __swig_setmethods__["viseme_id"] = _speech_py_impl.SpeechSynthesisVisemeEventArgs_viseme_id_set
    __swig_getmethods__["viseme_id"] = _speech_py_impl.SpeechSynthesisVisemeEventArgs_viseme_id_get
    if _newclass:
        viseme_id = _swig_property(_speech_py_impl.SpeechSynthesisVisemeEventArgs_viseme_id_get, _speech_py_impl.SpeechSynthesisVisemeEventArgs_viseme_id_set)
    __swig_getmethods__["animation"] = _speech_py_impl.SpeechSynthesisVisemeEventArgs_animation_get
    if _newclass:
        animation = _swig_property(_speech_py_impl.SpeechSynthesisVisemeEventArgs_animation_get)
SpeechSynthesisVisemeEventArgs_swigregister = _speech_py_impl.SpeechSynthesisVisemeEventArgs_swigregister
SpeechSynthesisVisemeEventArgs_swigregister(SpeechSynthesisVisemeEventArgs)

class SpeechSynthesisBookmarkEventArgs(EventArgs):
    __swig_setmethods__ = {}
    for _s in [EventArgs]:
        __swig_setmethods__.update(getattr(_s, '__swig_setmethods__', {}))
    __setattr__ = lambda self, name, value: _swig_setattr(self, SpeechSynthesisBookmarkEventArgs, name, value)
    __swig_getmethods__ = {}
    for _s in [EventArgs]:
        __swig_getmethods__.update(getattr(_s, '__swig_getmethods__', {}))
    __getattr__ = lambda self, name: _swig_getattr(self, SpeechSynthesisBookmarkEventArgs, name)

    def __init__(self, *args, **kwargs):
        raise AttributeError("No constructor defined")
    __repr__ = _swig_repr
    __swig_destroy__ = _speech_py_impl.delete_SpeechSynthesisBookmarkEventArgs
    __del__ = lambda self: None
    __swig_setmethods__["audio_offset"] = _speech_py_impl.SpeechSynthesisBookmarkEventArgs_audio_offset_set
    __swig_getmethods__["audio_offset"] = _speech_py_impl.SpeechSynthesisBookmarkEventArgs_audio_offset_get
    if _newclass:
        audio_offset = _swig_property(_speech_py_impl.SpeechSynthesisBookmarkEventArgs_audio_offset_get, _speech_py_impl.SpeechSynthesisBookmarkEventArgs_audio_offset_set)
    __swig_getmethods__["text"] = _speech_py_impl.SpeechSynthesisBookmarkEventArgs_text_get
    if _newclass:
        text = _swig_property(_speech_py_impl.SpeechSynthesisBookmarkEventArgs_text_get)
SpeechSynthesisBookmarkEventArgs_swigregister = _speech_py_impl.SpeechSynthesisBookmarkEventArgs_swigregister
SpeechSynthesisBookmarkEventArgs_swigregister(SpeechSynthesisBookmarkEventArgs)

class SynthesisVoicesResult(_object):
    __swig_setmethods__ = {}
    __setattr__ = lambda self, name, value: _swig_setattr(self, SynthesisVoicesResult, name, value)
    __swig_getmethods__ = {}
    __getattr__ = lambda self, name: _swig_getattr(self, SynthesisVoicesResult, name)

    def __init__(self, *args, **kwargs):
        raise AttributeError("No constructor defined")
    __repr__ = _swig_repr
    __swig_destroy__ = _speech_py_impl.delete_SynthesisVoicesResult
    __del__ = lambda self: None
    __swig_getmethods__["voices"] = _speech_py_impl.SynthesisVoicesResult_voices_get
    if _newclass:
        voices = _swig_property(_speech_py_impl.SynthesisVoicesResult_voices_get)
    __swig_getmethods__["error_details"] = _speech_py_impl.SynthesisVoicesResult_error_details_get
    if _newclass:
        error_details = _swig_property(_speech_py_impl.SynthesisVoicesResult_error_details_get)
    __swig_getmethods__["result_id"] = _speech_py_impl.SynthesisVoicesResult_result_id_get
    if _newclass:
        result_id = _swig_property(_speech_py_impl.SynthesisVoicesResult_result_id_get)
    __swig_getmethods__["_reason"] = _speech_py_impl.SynthesisVoicesResult__reason_get
    if _newclass:
        _reason = _swig_property(_speech_py_impl.SynthesisVoicesResult__reason_get)
    __swig_getmethods__["properties"] = _speech_py_impl.SynthesisVoicesResult_properties_get
    if _newclass:
        properties = _swig_property(_speech_py_impl.SynthesisVoicesResult_properties_get)
    ...
    def reason(self)  :
        """
        The voices list retrieving reason
        """
        return ResultReason(self._reason)

SynthesisVoicesResult_swigregister = _speech_py_impl.SynthesisVoicesResult_swigregister
SynthesisVoicesResult_swigregister(SynthesisVoicesResult)

class VoiceInfo(_object):
    __swig_setmethods__ = {}
    __setattr__ = lambda self, name, value: _swig_setattr(self, VoiceInfo, name, value)
    __swig_getmethods__ = {}
    __getattr__ = lambda self, name: _swig_getattr(self, VoiceInfo, name)

    def __init__(self, *args, **kwargs):
        raise AttributeError("No constructor defined")
    __repr__ = _swig_repr
    __swig_destroy__ = _speech_py_impl.delete_VoiceInfo
    __del__ = lambda self: None
    __swig_getmethods__["name"] = _speech_py_impl.VoiceInfo_name_get
    if _newclass:
        name = _swig_property(_speech_py_impl.VoiceInfo_name_get)
    __swig_getmethods__["locale"] = _speech_py_impl.VoiceInfo_locale_get
    if _newclass:
        locale = _swig_property(_speech_py_impl.VoiceInfo_locale_get)
    __swig_getmethods__["short_name"] = _speech_py_impl.VoiceInfo_short_name_get
    if _newclass:
        short_name = _swig_property(_speech_py_impl.VoiceInfo_short_name_get)
    __swig_getmethods__["local_name"] = _speech_py_impl.VoiceInfo_local_name_get
    if _newclass:
        local_name = _swig_property(_speech_py_impl.VoiceInfo_local_name_get)
    __swig_getmethods__["gender"] = _speech_py_impl.VoiceInfo_gender_get
    if _newclass:
        gender = _swig_property(_speech_py_impl.VoiceInfo_gender_get)
    __swig_getmethods__["voice_type"] = _speech_py_impl.VoiceInfo_voice_type_get
    if _newclass:
        voice_type = _swig_property(_speech_py_impl.VoiceInfo_voice_type_get)
    __swig_getmethods__["style_list"] = _speech_py_impl.VoiceInfo_style_list_get
    if _newclass:
        style_list = _swig_property(_speech_py_impl.VoiceInfo_style_list_get)
    __swig_getmethods__["voice_path"] = _speech_py_impl.VoiceInfo_voice_path_get
    if _newclass:
        voice_path = _swig_property(_speech_py_impl.VoiceInfo_voice_path_get)
    __swig_getmethods__["properties"] = _speech_py_impl.VoiceInfo_properties_get
    if _newclass:
        properties = _swig_property(_speech_py_impl.VoiceInfo_properties_get)

    def __str__(self):
        return u'{}:(name={})'.format(type(self), self.name)

VoiceInfo_swigregister = _speech_py_impl.VoiceInfo_swigregister
VoiceInfo_swigregister(VoiceInfo)
...
class SpeechSynthesisEventSignal(_object):
    ...
    def signal(self, t )  :
        ...
        """
        return _speech_py_impl.SpeechSynthesisEventSignal_signal(self, t)
...
class SpeechSynthesisWordBoundaryEventSignal(_object):
    ...
    def signal(self, t )  :
        ...
        """
        return _speech_py_impl.SpeechSynthesisWordBoundaryEventSignal_signal(self, t)
...
class SpeechSynthesisVisemeEventSignal(_object):
    """
    ...
    __swig_setmethods__ = {}
    __setattr__ = lambda self, name, value: _swig_setattr(self, SpeechSynthesisVisemeEventSignal, name, value)
    __swig_getmethods__ = {}
    __getattr__ = lambda self, name: _swig_getattr(self, SpeechSynthesisVisemeEventSignal, name)
    ...
    def disconnect_all(self)  :
        ...
        """
        return _speech_py_impl.SpeechSynthesisVisemeEventSignal_disconnect_all(self)
    ...
    def signal(self, t )  :
        ...
        """
        return _speech_py_impl.SpeechSynthesisVisemeEventSignal_signal(self, t)
    ...
    def connect(self, func , wrapped_type )  :
        ...
        """
        return _speech_py_impl.SpeechSynthesisVisemeEventSignal_connect(self, func, wrapped_type)

    __swig_destroy__ = _speech_py_impl.delete_SpeechSynthesisVisemeEventSignal
    __del__ = lambda self: None
SpeechSynthesisVisemeEventSignal_swigregister = _speech_py_impl.SpeechSynthesisVisemeEventSignal_swigregister
SpeechSynthesisVisemeEventSignal_swigregister(SpeechSynthesisVisemeEventSignal)

class SpeechSynthesisBookmarkEventSignal(_object):
    """
    ...
    __swig_setmethods__ = {}
    __setattr__ = lambda self, name, value: _swig_setattr(self, SpeechSynthesisBookmarkEventSignal, name, value)
    __swig_getmethods__ = {}
    __getattr__ = lambda self, name: _swig_getattr(self, SpeechSynthesisBookmarkEventSignal, name)
    ...
    def disconnect_all(self)  :
        ...
        """
        return _speech_py_impl.SpeechSynthesisBookmarkEventSignal_disconnect_all(self)
    ...
    def signal(self, t )  :
        ...
        """
        return _speech_py_impl.SpeechSynthesisBookmarkEventSignal_signal(self, t)
    ...
    def connect(self, func , wrapped_type )  :
        ...
        """
        return _speech_py_impl.SpeechSynthesisBookmarkEventSignal_connect(self, func, wrapped_type)

    __swig_destroy__ = _speech_py_impl.delete_SpeechSynthesisBookmarkEventSignal
    __del__ = lambda self: None
SpeechSynthesisBookmarkEventSignal_swigregister = _speech_py_impl.SpeechSynthesisBookmarkEventSignal_swigregister
SpeechSynthesisBookmarkEventSignal_swigregister(SpeechSynthesisBookmarkEventSignal)
...
class SpeechSynthesizer(_object):
    ...
    __swig_getmethods__["viseme_received"] = _speech_py_impl.SpeechSynthesizer_viseme_received_get
    if _newclass:
        viseme_received = _swig_property(_speech_py_impl.SpeechSynthesizer_viseme_received_get)
    __swig_getmethods__["bookmark_reached"] = _speech_py_impl.SpeechSynthesizer_bookmark_reached_get
    if _newclass:
        bookmark_reached = _swig_property(_speech_py_impl.SpeechSynthesizer_bookmark_reached_get)
    ...
    def stop_speaking(self)  :
        return _speech_py_impl.SpeechSynthesizer_stop_speaking(self)

    def stop_speaking_async(self)  :
        return _speech_py_impl.SpeechSynthesizer_stop_speaking_async(self)

    def get_voices_async(self, locale )  :
        return _speech_py_impl.SpeechSynthesizer_get_voices_async(self, locale)
...
class KeywordRecognitionResult(RecognitionResult):
    ...
    for _s in [RecognitionResult]:
        __swig_setmethods__.update(getattr(_s, '__swig_setmethods__', {}))
    __setattr__ = lambda self, name, value: _swig_setattr(self, KeywordRecognitionResult, name, value)
    __swig_getmethods__ = {}
    for _s in [RecognitionResult]:
        __swig_getmethods__.update(getattr(_s, '__swig_getmethods__', {}))
    __getattr__ = lambda self, name: _swig_getattr(self, KeywordRecognitionResult, name)

    def __init__(self, *args, **kwargs):
        raise AttributeError("No constructor defined")
    __repr__ = _swig_repr
    __swig_destroy__ = _speech_py_impl.delete_KeywordRecognitionResult
    __del__ = lambda self: None
...
KeywordRecognitionResult_swigregister = _speech_py_impl.KeywordRecognitionResult_swigregister
KeywordRecognitionResult_swigregister(KeywordRecognitionResult)

class KeywordRecognitionEventArgs(RecognitionEventArgs):
    __swig_setmethods__ = {}
    for _s in [RecognitionEventArgs]:
        __swig_setmethods__.update(getattr(_s, '__swig_setmethods__', {}))
    __setattr__ = lambda self, name, value: _swig_setattr(self, KeywordRecognitionEventArgs, name, value)
    __swig_getmethods__ = {}
    for _s in [RecognitionEventArgs]:
        __swig_getmethods__.update(getattr(_s, '__swig_getmethods__', {}))
    __getattr__ = lambda self, name: _swig_getattr(self, KeywordRecognitionEventArgs, name)

    def __init__(self, *args, **kwargs):
        raise AttributeError("No constructor defined")
    __repr__ = _swig_repr
    __swig_destroy__ = _speech_py_impl.delete_KeywordRecognitionEventArgs
    __del__ = lambda self: None

    def _get_result(self)  :
        return _speech_py_impl.KeywordRecognitionEventArgs__get_result(self)

    @property
    def result(self)  :
        """
        Contains the keyword recognition result.
        """
        return self._get_result()

KeywordRecognitionEventArgs_swigregister = _speech_py_impl.KeywordRecognitionEventArgs_swigregister
KeywordRecognitionEventArgs_swigregister(KeywordRecognitionEventArgs)

class KeywordRecognitionEventSignal(_object):
    """
    ...
    __swig_setmethods__ = {}
    __setattr__ = lambda self, name, value: _swig_setattr(self, KeywordRecognitionEventSignal, name, value)
    __swig_getmethods__ = {}
    __getattr__ = lambda self, name: _swig_getattr(self, KeywordRecognitionEventSignal, name)
    ...
    def disconnect_all(self)  :
        ...
        """
        return _speech_py_impl.KeywordRecognitionEventSignal_disconnect_all(self)
    ...
    def signal(self, t )  :
        ...
        """
        return _speech_py_impl.KeywordRecognitionEventSignal_signal(self, t)
    ...
    def connect(self, func , wrapped_type )  :
        ...
        """
        return _speech_py_impl.KeywordRecognitionEventSignal_connect(self, func, wrapped_type)

    __swig_destroy__ = _speech_py_impl.delete_KeywordRecognitionEventSignal
    __del__ = lambda self: None
KeywordRecognitionEventSignal_swigregister = _speech_py_impl.KeywordRecognitionEventSignal_swigregister
KeywordRecognitionEventSignal_swigregister(KeywordRecognitionEventSignal)

class KeywordRecognizer(_object):
    __swig_setmethods__ = {}
    __setattr__ = lambda self, name, value: _swig_setattr(self, KeywordRecognizer, name, value)
    __swig_getmethods__ = {}
    __getattr__ = lambda self, name: _swig_getattr(self, KeywordRecognizer, name)

    def __init__(self, *args, **kwargs):
        raise AttributeError("No constructor defined")
    __repr__ = _swig_repr
    if _newclass:
        _from_config = staticmethod(_speech_py_impl.KeywordRecognizer__from_config)
    else:
        _from_config = _speech_py_impl.KeywordRecognizer__from_config
    __swig_destroy__ = _speech_py_impl.delete_KeywordRecognizer
    __del__ = lambda self: None
    __swig_getmethods__["recognized"] = _speech_py_impl.KeywordRecognizer_recognized_get
    if _newclass:
        recognized = _swig_property(_speech_py_impl.KeywordRecognizer_recognized_get)
    __swig_getmethods__["canceled"] = _speech_py_impl.KeywordRecognizer_canceled_get
    if _newclass:
        canceled = _swig_property(_speech_py_impl.KeywordRecognizer_canceled_get)
    __swig_getmethods__["properties"] = _speech_py_impl.KeywordRecognizer_properties_get
    if _newclass:
        properties = _swig_property(_speech_py_impl.KeywordRecognizer_properties_get)

    def recognize_once_async(self, model )  :
        return _speech_py_impl.KeywordRecognizer_recognize_once_async(self, model)

    def stop_recognition_async(self)  :
        return _speech_py_impl.KeywordRecognizer_stop_recognition_async(self)
KeywordRecognizer_swigregister = _speech_py_impl.KeywordRecognizer_swigregister
KeywordRecognizer_swigregister(KeywordRecognizer)

def KeywordRecognizer__from_config(audioConfig =0)  :
    return _speech_py_impl.KeywordRecognizer__from_config(audioConfig)
KeywordRecognizer__from_config = _speech_py_impl.KeywordRecognizer__from_config
...
def TranslationRecognizer__from_config(*args)  :
    return _speech_py_impl.TranslationRecognizer__from_config(*args)
...
class DialogServiceConnector(_object):
    ...
    def set_speech_activity_template(self, activityTemplate )  :
        return _speech_py_impl.DialogServiceConnector_set_speech_activity_template(self, activityTemplate)

    def get_speech_activity_template(self)  :
        return _speech_py_impl.DialogServiceConnector_get_speech_activity_template(self)
    ...
    __swig_getmethods__["turn_status_received"] = _speech_py_impl.DialogServiceConnector_turn_status_received_get
    if _newclass:
        turn_status_received = _swig_property(_speech_py_impl.DialogServiceConnector_turn_status_received_get)
    ...
    def stop_listening_async(self)  :
        return _speech_py_impl.DialogServiceConnector_stop_listening_async(self)
...
def DialogServiceConnector_from_config(connectorConfig , audioConfig =0)  :
    return _speech_py_impl.DialogServiceConnector_from_config(connectorConfig, audioConfig)
...
class Connection(_object):
    ...
    if _newclass:
        from_dialog_service_connector = staticmethod(_speech_py_impl.Connection_from_dialog_service_connector)
    else:
        from_dialog_service_connector = _speech_py_impl.Connection_from_dialog_service_connector
    if _newclass:
        from_speech_synthesizer = staticmethod(_speech_py_impl.Connection_from_speech_synthesizer)
    else:
        from_speech_synthesizer = _speech_py_impl.Connection_from_speech_synthesizer
...
def Connection_from_dialog_service_connector(dialogServiceConnector )  :
    return _speech_py_impl.Connection_from_dialog_service_connector(dialogServiceConnector)
Connection_from_dialog_service_connector = _speech_py_impl.Connection_from_dialog_service_connector

def Connection_from_speech_synthesizer(synthesizer )  :
    return _speech_py_impl.Connection_from_speech_synthesizer(synthesizer)
Connection_from_speech_synthesizer = _speech_py_impl.Connection_from_speech_synthesizer
...
class GrammarList(Grammar):
    ...
    def set_recognition_factor(self, factor , scope )  :
        return _speech_py_impl.GrammarList_set_recognition_factor(self, factor, scope)
...
class PronunciationAssessmentConfig(_object):
    __swig_setmethods__ = {}
    __setattr__ = lambda self, name, value: _swig_setattr(self, PronunciationAssessmentConfig, name, value)
    __swig_getmethods__ = {}
    __getattr__ = lambda self, name: _swig_getattr(self, PronunciationAssessmentConfig, name)

    def __init__(self, *args, **kwargs):
        raise AttributeError("No constructor defined")
    __repr__ = _swig_repr
    if _newclass:
        _create = staticmethod(_speech_py_impl.PronunciationAssessmentConfig__create)
    else:
        _create = _speech_py_impl.PronunciationAssessmentConfig__create
    if _newclass:
        _create_from_json = staticmethod(_speech_py_impl.PronunciationAssessmentConfig__create_from_json)
    else:
        _create_from_json = _speech_py_impl.PronunciationAssessmentConfig__create_from_json

    def to_json(self)  :
        return _speech_py_impl.PronunciationAssessmentConfig_to_json(self)

    def get_reference_text(self)  :
        return _speech_py_impl.PronunciationAssessmentConfig_get_reference_text(self)

    def set_reference_text(self, referenceText )  :
        return _speech_py_impl.PronunciationAssessmentConfig_set_reference_text(self, referenceText)

    def apply_to(self, recognizer )  :
        return _speech_py_impl.PronunciationAssessmentConfig_apply_to(self, recognizer)
    __swig_destroy__ = _speech_py_impl.delete_PronunciationAssessmentConfig
    __del__ = lambda self: None
PronunciationAssessmentConfig_swigregister = _speech_py_impl.PronunciationAssessmentConfig_swigregister
PronunciationAssessmentConfig_swigregister(PronunciationAssessmentConfig)

def PronunciationAssessmentConfig__create(*args)  :
    return _speech_py_impl.PronunciationAssessmentConfig__create(*args)
PronunciationAssessmentConfig__create = _speech_py_impl.PronunciationAssessmentConfig__create

def PronunciationAssessmentConfig__create_from_json(json )  :
    return _speech_py_impl.PronunciationAssessmentConfig__create_from_json(json)
PronunciationAssessmentConfig__create_from_json = _speech_py_impl.PronunciationAssessmentConfig__create_from_json

class PronunciationAssessmentResult(_object):
    __swig_setmethods__ = {}
    __setattr__ = lambda self, name, value: _swig_setattr(self, PronunciationAssessmentResult, name, value)
    __swig_getmethods__ = {}
    __getattr__ = lambda self, name: _swig_getattr(self, PronunciationAssessmentResult, name)

    def __init__(self, *args, **kwargs):
        raise AttributeError("No constructor defined")
    __repr__ = _swig_repr
    if _newclass:
        _from_result = staticmethod(_speech_py_impl.PronunciationAssessmentResult__from_result)
    else:
        _from_result = _speech_py_impl.PronunciationAssessmentResult__from_result
    __swig_getmethods__["accuracy_score"] = _speech_py_impl.PronunciationAssessmentResult_accuracy_score_get
    if _newclass:
        accuracy_score = _swig_property(_speech_py_impl.PronunciationAssessmentResult_accuracy_score_get)
    __swig_getmethods__["pronunciation_score"] = _speech_py_impl.PronunciationAssessmentResult_pronunciation_score_get
    if _newclass:
        pronunciation_score = _swig_property(_speech_py_impl.PronunciationAssessmentResult_pronunciation_score_get)
    __swig_getmethods__["completeness_score"] = _speech_py_impl.PronunciationAssessmentResult_completeness_score_get
    if _newclass:
        completeness_score = _swig_property(_speech_py_impl.PronunciationAssessmentResult_completeness_score_get)
    __swig_getmethods__["fluency_score"] = _speech_py_impl.PronunciationAssessmentResult_fluency_score_get
    if _newclass:
        fluency_score = _swig_property(_speech_py_impl.PronunciationAssessmentResult_fluency_score_get)
    __swig_destroy__ = _speech_py_impl.delete_PronunciationAssessmentResult
    __del__ = lambda self: None
PronunciationAssessmentResult_swigregister = _speech_py_impl.PronunciationAssessmentResult_swigregister
PronunciationAssessmentResult_swigregister(PronunciationAssessmentResult)

def PronunciationAssessmentResult__from_result(result )  :
    return _speech_py_impl.PronunciationAssessmentResult__from_result(result)
PronunciationAssessmentResult__from_result = _speech_py_impl.PronunciationAssessmentResult__from_result
...
inject_enum('SynthesisVoiceGender')
inject_enum('SynthesisVoiceType')
