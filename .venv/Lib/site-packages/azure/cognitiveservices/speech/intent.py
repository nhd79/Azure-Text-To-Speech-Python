...
class LanguageUnderstandingModel():
    ...
    - from endpoint: pass an endpoint URL.  (see `<https://docs.microsoft.com/azure/cognitive-services/speech-service/quickstarts/intent-recognition>` for more details).
