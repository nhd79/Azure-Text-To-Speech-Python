...
class TranslationRecognizer(Recognizer):
    ...
    @staticmethod
    def _get_impl(config_type, translation_config, auto_detect_source_language_config, audio_config):
        if auto_detect_source_language_config is None:
            if audio_config is None:
                return config_type._from_config(translation_config._impl)
        ...
        if audio_config is None:
            return config_type._from_config(translation_config._impl, auto_detect_source_language_config._impl)
        return config_type._from_config(translation_config._impl, auto_detect_source_language_config._impl, audio_config._impl)
